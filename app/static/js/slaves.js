$(function() {
  ...
  function renderResponse(data) {
    ...
    renderDisclaimer(data.jobs_limit);
  ...
  function renderDisclaimer(jobs) {
    $info.show();
    $info.text("Only slaves with more than " + jobs + " jobs are displayed.");
  }
    ...
    $.each(slaves, function(index, value) {
      ...
      $.each(tableColumns, function(i, v) {
        ...
        if (v == "slave") {
          ...
          cell.attr("data-no-retries", stats[v]["fail_rate"]);
          cell.attr("data-with-retries", stats[v]["fail_rate_retries"]);
        }
